...
if __name__ == '__main__':
    ...
    global pub, fixed_frame
    fixed_frame = rospy.get_param("/fixed_frame")

    pub = rospy.Publisher('virtual_update_joint_position',Float64MultiArray)
    rospy.Subscriber('/initial_marker', String, initial_callback)
    rospy.Subscriber('/virtual_joint_states', JointState, joint_state_callback)

    server = InteractiveMarkerServer("basic_marker")

    interactive_marker = makeInteractiveMarker("basic", "")
